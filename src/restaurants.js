const restaurants = {
  "1": {
    ...
    address: 'Rua de Santa Marta 48',
    rating: 4.9,
    cousine: ['Saudável', 'Europeia', 'Mediterrânea'],
    type: ['Gluten Free'],
    ...
    tags: ['marques', 'marquês', 'Marquês de Pombal'],
    images: ['/the-greenest/restaurants/santamarta01.jpg', '/the-greenest/restaurants/santamarta02.jpg', '/the-greenest/restaurants/santamarta03.jpg'],
    openingHours: {
  ...
  "2": {
    ...
    rating: 4.3,
    type: ['Orgânico'],
    cousine: ['Internacional', 'Mediterrânea', 'Europeia'],
    ...
    images: ['/the-greenest/restaurants/season01.jpg', '/the-greenest/restaurants/season02.jpg'],
    certificates: [],
    tags: ['marques', 'marquês', 'Marquês de Pombal'],
    openingHours: {
  ...
  "3": {
    ...
    images: ['/the-greenest/restaurants/feitoria01.jpg', '/the-greenest/restaurants/feitoria02.jpg'],
    openingHours: {
      '2a a 6a feira': ['10h00 às 14h30'],
      'Sábados': ['10h00 às 14h30'],
      'Domingos e Feriados': ['11h00 às 15h00']
  ...
  "4": {
    ...
    rating: 3.9,
    type: ['Biológico'],
    cousine: ['Mediterrânea', 'Europeia', 'Saudável'],
    certificates: ['biologic'],
    tags: ['marques', 'marquês', 'Marquês de Pombal'],
    ...
    images: ['/the-greenest/restaurants/sala01.jpg', '/the-greenest/restaurants/sala02.jpg'],
    openingHours: {
